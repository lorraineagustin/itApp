                          ...
                          <form class="network-related-form">
                            <div class="swiper mySwiper">
                                      ...
                                      <div class="swiper-slide">
                                        <div class="swiper-content-holder">
                                            ...
                                            {{-- <div class="final-form-confirmation"> --}}
                                              ...
                                              <table font size="2" height="50px" class="table table-bordered table-hover table-sm">
                                                <tr>
                                                  <td bgcolor="#b5b1b0">Request Date</td>
                                                  <td>2021-06-21</td>
                                                  <td bgcolor="#b5b1b0">Date Hired</td>
                                                  <td>2018-10-20</td>
                                                </tr>
                                                <tr>
                                                    <td bgcolor="#b5b1b0">Request By</td>
                                                    <td>Roselle Alcantara</td>
                                                    <td bgcolor="#b5b1b0">Department</td>
                                                    <td>PID</td>
                                                </tr>
                                                <tr>
                                                    <td bgcolor="#b5b1b0">Verified By</td>
                                                    <td>Menandro Dizon</td>
                                                    <td bgcolor="#b5b1b0">Process/Section</td>
                                                    <td>YP</td>
                                                </tr>
                                              </table>
                                              ...
                                              <table class="table table-bordered table-hover table-sm">
                                                  <tr>
                                                  <td height="10" bgcolor="#b5b1b0" style="width: 23%">Employee Name</td>
                                              ...
                                              <table class="table table-bordered table-hover table-sm">
                                                  <tr>
                                                    <td bgcolor="#b5b1b0" style="width: 23%">Application Date</td>
                                                    <td style="width: 30%">2021-06-18</td>
                                                    <td bgcolor="#b5b1b0" style="width: 25%">Process</td>
                                                    <td>YP</td>
                                                  </tr>
                                                  <tr>
                                                      <td bgcolor="#b5b1b0">Global ID</td>
                                                      <td>19G500006</td>
                                                      <td bgcolor="#b5b1b0">PC Name</td>
                                                      <td>PC16060165J</td>
                                                  </tr>
                                                </table>
                                                ...
                                                <table class="table table-bordered table-hover table-sm">
                                                  <tr>
                                                    <td bgcolor="#b5b1b0" style="width: 23%">Request Type</td>
                                                    <td style="width: 30%">PC, Logon, Email </td>
                                                    <td bgcolor="#b5b1b0">Application Services</td>
                                ...
                                <div class="progress-btn">
                                    <button type="button" class="btn btn-danger swiper-button-next">Deny</button>
                                    <button type="button" class="btn btn-progress swiper-button-prev">Approve</button>
                                </div>
